...
var buster = require('buster'),
    ...
    plugin = require('../../plugins/boilerplate')({
        disabled: false,
        execute_if_regexp : '.',
        name: 'boilerplate'
    });

buster.testCase('plugins/boilerplate.js', {
    setUp: function () {
    },
    ...
    'Date module:': {
        ...
        'execute': function (done) {
            plugin.execute(JSON.stringify('{"foo": "This is my message.norway", "text": "I am from norway"}'), {}, function () {
                assert(true);
                done();
            });
        },
